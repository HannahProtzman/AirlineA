...
class AirlineTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        cell.textLabel?.text = FAA.airlines[indexPath.row].name
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let destination = segue.destination as! CitiesFlownTableViewController
        let index = tableView.indexPathForSelectedRow!.row
        destination.airline = FAA.airlineNum(index)
    }
